...
function EditFilm(props) {  
        ...
        const Url = "http://193.10.202.71/Filmservice/film/GetFilm?id=" + props.match.params.id;  
        ...
        const UpdateFilm = (e) => {  
         ...
         e.preventDefault();  
          ...
          const data = {Id:props.match.params.id, Titel:Film.Titel, Beskrivning: Film.Beskrivning, Aldergrans: Film.Aldergrans, Genre:Film.Genre, Sprak: Film.Sprak, Huvudregissor: Film.Huvudregissor};  
      ...
      <div>   
         <Link to={'/filmLista'} className="nav-link">Tillbacka</Link> 
         <br/>
    
                <div id="edit" className="app flex-row align-items-center">  
